...
class launchpad(tk.Frame):
    ...
    def createwidgets(self):
        ...
        self.btnnum1_origin = tk.Button(self, image=self.btnnum1_origin_gif, height=70, width=80, bd=5, bg='black',command=self.threaded_run_1_origin)
        self.btnnum2_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn1_1.gif')
        self.btnnum2_origin = tk.Button(self, image=self.btnnum2_origin_gif, height=70, width=80, bd=5, bg='black',command=self.threaded_run_2_origin)
        self.btnnum3_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn2_1.gif')
        self.btnnum3_origin = tk.Button(self, image=self.btnnum3_origin_gif, height=70, width=80, bd=5, bg='black',command=self.threaded_run_3_origin)
        self.btnnum4_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn3_1.gif')
        self.btnnum4_origin = tk.Button(self, image=self.btnnum4_origin_gif, height=70, width=80, bd=5, bg='black',command=self.threaded_run_4_origin)
        # 升key
